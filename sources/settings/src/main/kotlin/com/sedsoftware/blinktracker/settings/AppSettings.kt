...
class AppSettings(
    ...
    private val replacePipEnabledKey: Preferences.Key<Boolean> = booleanPreferencesKey("replace_pip_enabled")
    ...
    override suspend fun getReplacePipEnabled(): Flow<Boolean> =
        getPrefsValue(replacePipEnabledKey, REPLACE_PIP_DEFAULT)
    ...
    override suspend fun setReplacePipEnabled(value: Boolean) =
        setPrefsValue(replacePipEnabledKey, value)
    ...
    private companion object {
        ...
        const val REPLACE_PIP_DEFAULT = false
    }
}
